...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      <div className="fixed bottom-8 right-8 z-50 h-16 w-16">
        <a
          className="relative flex h-[60px] w-[60px]"
          href="https://api.whatsapp.com/send/?phone=%2B917016913718&text&type=phone_number&text=I%20want%20to%20understand%20about"
          target="_blank"
        >
